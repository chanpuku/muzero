        ...
        while ray.get(
            ...
            if self.config.use_last_model_value:
                for i in range(len(game_history.root_values)):
                    observation=numpy.array([game_history.get_stacked_observations(i,self.config.stacked_observations,len(self.config.action_space),)])
                    observation=(
            ...
            print(f'reanalyze:value.shape:{values.size()},storage{sys.getsizeof(values.storage())}')
            print('')
